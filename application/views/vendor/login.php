    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form name="frmlogin" id="frmlogin" action="<?php echo base_url(VENDORPATH.'login/dologin/')?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="checkbox icheck">
                                <label>
                                    <a href="<?php echo base_url().VENDORPATH; ?>forgotpassword">I forgot my password</a>
                                </label>
                            </div>
                        </div>
                        <div class="col-xs-4">
